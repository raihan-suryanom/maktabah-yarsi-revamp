...
export const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-lg font-bold ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "bg-light-100 text-dark-100 hover:bg-light-100/80 dark:bg-dark-100 dark:text-light-100 dark:hover:bg-dark-100/80",
        outline:
      ...
      size: {
        large: "px-7 py-5 font-poppins text-2xl font-normal",
        medium: "px-5 py-2.5 font-lpmq text-7xl",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
